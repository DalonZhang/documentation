...
applied on the same product line that has its :ref:`taxes/base-affected`. As such, the subsequent
tax's base is the sum of the tax-excluded base and this tax's tax amount.

.. tabs::
   .. tab:: Tax-excluded
      If :guilabel:`Affect base of subsequent taxes` is enabled and :guilabel:`Included in Price` is
      set to :guilabel:`Tax Excluded`, subsequent taxes with :guilabel:`Base affected by preceding
      taxes` will be based on a modified sales price equal to the original sales price plus the tax
      amount.
   ...
   .. tab:: Tax-included
      If :guilabel:`Affect base of subsequent taxes` is enabled and :guilabel:`Included in Price` is
      set to :guilabel:`Tax Included`, subsequent taxes with :guilabel:`Base affected by preceding
      taxes` will be based on the original sales price.
...
.. tabs::
   .. tab:: Tax-excluded
      ...
      is set to :guilabel:`Tax Excluded`, subsequent taxes with :guilabel:`Base affected by
      preceding taxes` will be based on the original sales price.
   ...
   .. tab:: Tax-included
      If :guilabel:`Affect base of subsequent taxes` is disabled and :guilabel:`Included in Price`
      is set to :guilabel:`Tax Included`, subsequent taxes with :guilabel:`Base affected by
      preceding taxes` will be based on a modified sales price equal to the original sales price
